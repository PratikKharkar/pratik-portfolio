      ...
      <div className="relative mx-auto grid w-full max-w-7xl items-center gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
        ...
        <div className="animate-hero-left">
          ...
          <div className="mb-5 flex items-center gap-3 sm:mb-7">
            ...
            <span className="relative h-px w-10 overflow-hidden bg-yellow-400/20 sm:w-12">
              <span className="absolute inset-y-0 left-0 w-full bg-yellow-400 animate-hero-line" />
            </span>

            <span className="text-[10px] font-medium uppercase tracking-[0.28em] text-yellow-400 sm:text-xs sm:tracking-[0.35em]">
              Software Developer
            </span>
          ...
          <h1 className="animate-hero-heading text-4xl font-bold leading-[1.05] tracking-tight text-white sm:text-6xl lg:text-7xl">
            ...
            <span className="relative text-yellow-400">
              ...
              <span className="absolute -bottom-1 left-0 h-[2px] w-full origin-left bg-yellow-400 animate-hero-underline sm:-bottom-2" />
            </span>
            .
          </h1>
          ...
          <div className="animate-hero-buttons mt-7 flex flex-wrap gap-3 sm:mt-9 sm:gap-4">
            ...
            <a
              href="#projects"
              className="group relative overflow-hidden rounded-lg bg-yellow-400 px-5 py-3 text-sm font-semibold text-black transition duration-300 hover:-translate-y-1 hover:bg-yellow-300 hover:shadow-[0_12px_35px_rgba(250,204,21,0.2)] sm:px-7 sm:py-3.5"
            >
            ...
            <a
              href="/resume.pdf"
              download
              className="rounded-lg border border-white/15 px-5 py-3 text-sm font-semibold text-gray-200 transition duration-300 hover:-translate-y-1 hover:border-yellow-400 hover:text-yellow-400 sm:px-7 sm:py-3.5"
            >
              Download Resume ↓
            </a>
          ...
          <div className="animate-hero-social mt-6 flex flex-wrap items-center gap-4 sm:mt-9 sm:gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-xs text-gray-500 transition duration-300 hover:text-yellow-400 sm:text-sm"
            >
              GitHub ↗
            </a>
        ...
        <div className="animate-hero-profile flex justify-center lg:justify-end">
          ...
          <div className="relative">
            ...
            <div className="absolute -inset-10 rounded-full bg-yellow-400/[0.05] blur-[80px] animate-hero-glow sm:-inset-16 sm:blur-[100px]" />

            {/* Ring */}

            <div className="absolute -inset-4 rounded-full border border-yellow-400/20 animate-hero-spin sm:-inset-6" />

            {/* Profile Container */}

            <div className="relative h-[230px] w-[230px] overflow-hidden rounded-full border border-yellow-400/30 bg-[#111] shadow-[0_0_60px_rgba(250,204,21,0.08)] sm:h-[320px] sm:w-[320px] lg:h-[400px] lg:w-[400px]">
